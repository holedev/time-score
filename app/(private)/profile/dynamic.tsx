...
const Profile = async ({ user }: { user: User }) => (
  <Card>
    <CardHeader>
      <CardTitle className='font-bold text-xl uppercase'>Profile</CardTitle>
      <CardDescription className='text-muted-foreground'>User profile information</CardDescription>
    </CardHeader>
